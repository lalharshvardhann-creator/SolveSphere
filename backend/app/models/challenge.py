...
class Challenge(Base):
    ...
    people_affected: Mapped[Optional[int]] = mapped_column(
        Integer,
        nullable=True,
    )
...
class ChallengeLocation(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "state = 'Jharkhand'",
            name="ck_challenge_location_jharkhand_only",
        ),
    )
    ...
    panchayat: Mapped[Optional[str]] = mapped_column(
        String(100),
        nullable=True,
    )
...
class ChallengeAIAnalysis(Base):
    ...
    duplicate_score: Mapped[Optional[float]] = mapped_column(
        Float,
        nullable=True,
    )
    required_expertise: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
    )
